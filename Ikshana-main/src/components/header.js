  ...
  return (
    ...
    >
      ...
      <header data-role="Header" className="header-header1">
        ...
        <Link to="/test" className="header-navlink2">
          {props.TESTS}
        </Link>
        <Link to="/connect" className="header-navlink3">
          {props.EXP}
        </Link>
        <Link to="/resources" className="header-navlink4">
          {props.RES}
        </Link>
        ...
        <div data-role="BurgerMenu" className="header-burger-menu1">
...
Header.defaultProps = {
  ...
  ABOUT: 'ABOUT',
  rootClassName: '',
  image_alt1: 'CONNECT WITH EXPERTS',
  link_text: 'https://example.com',
  image_src: '/playground_assets/logo-no-background2-1500h.png',
  TESTS: 'TESTS',
  image_alt: 'image',
  link_text2: 'https://example.com',
  image_src1:
    'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  EXP: 'CONNECT WITH EXPERTS',
